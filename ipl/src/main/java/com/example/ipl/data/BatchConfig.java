...
public class BatchConfig {
    ...
    // ------------------------Batch PROCESSOR PART-------------------------
    // we have done logic to each line
    @Bean
    ...
    // ------------------------Batch WRITER PART-------------------------
    // write back to instance by each line
    @Bean
    ...
    // -----------------------Now we need to tell whats our jobs
    // job---------------when explaining, this is the first step-----------------------
    @Bean
    ...
    public Step step1(JdbcBatchItemWriter<Match> writer) {
        return stepBuilderFactory
                ...
                .processor(processor())
                .writer(writer)
                .build(); // ---since our app only one step--------------end....................
    }
}
