...
// data rouse to server
public class MatchInput {
    

    /*
     * To people who doesn't know, use Ctrl+Alt+Up/Down arrow to insert cursor at
     * multiple lines to write that "private String" then do Shift+Alt+I to place
     * the cursor at the end of each line for ";"
     */
